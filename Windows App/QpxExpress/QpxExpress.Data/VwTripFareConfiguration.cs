...
namespace QpxExpress.Data
{
    ...
    public class VwTripFareConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<VwTripFare>
    {
        ...
        public VwTripFareConfiguration(string schema)
        {
            ...
            HasKey(x => new { x.DestinationId, x.Country, x.Destination, x.Airport, x.Airline, x.StopOvers, x.BusinessClass, x.TicketType });
            ...
            Property(x => x.Airport).HasColumnName(@"Airport").HasColumnType("nvarchar").IsRequired().HasMaxLength(10).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.Airline).HasColumnName(@"Airline").HasColumnType("nvarchar").IsRequired().HasMaxLength(10).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.StopOvers).HasColumnName(@"Stop Overs").HasColumnType("tinyint").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.BusinessClass).HasColumnName(@"Business Class").HasColumnType("nvarchar").IsRequired().HasMaxLength(3).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
